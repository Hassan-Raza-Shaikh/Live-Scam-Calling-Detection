...
\author{
\IEEEauthorblockN{Hassan Raza Shaikh\IEEEauthorrefmark{1}, Muhammad Ali Khan\IEEEauthorrefmark{2}, Maryam Arif\IEEEauthorrefmark{1}, and Fizza Aman\IEEEauthorrefmark{1}}
\IEEEauthorblockA{\IEEEauthorrefmark{1}\textit{Department of Computer Science}, \IEEEauthorrefmark{2}\textit{Department of Software Engineering} \\
Karachi, Pakistan \\
Emails: \{hassan.raza.shaikh, maryam.arif, fizza.aman\}@example.com, m.alikhan4927@gmail.com}
}
